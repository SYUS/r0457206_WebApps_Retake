...
<body onload="getFriends()">
	...
	<div class="container">
		...
		<div class="page-header">
  			<h1>
  				<c:choose>
  					<c:when test="${user.status ne null}">${user.name}, "${user.status}"</c:when>
		...
		<div class="panel panel-default">
  			<div class="panel-heading">Friends<div id="testAsyncDiv"></div></div>
  			<div class="panel-body">
  				...
  				<!-- <button type="button" class="btn btn-primary col-md-4" id="getFriendsButton" onclick="getFriends();">Load friends</button> -->
  			</div>
  			<div id="testAsyncDiv"></div>
  				<!-- Table -->
				<table class="table">
					<thead>
						<tr>
